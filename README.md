...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c6c8798c34bf3a86370cc7b41c2b9dd0e02660ea/P/pocl/pocl_next/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `pocl_next_jll.jl` have been built from these sources:

* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/c6c8798c34bf3a86370cc7b41c2b9dd0e02660ea/P/pocl/pocl_next/bundled)
* git repository: https://github.com/JuliaGPU/pocl (revision: `49af20c4b429d607f9cdb1f40557826ca8926753`)
...
`pocl_next_jll.jl` is available for the following platforms:

* `Platform("x86_64", "windows"; cxxstring_abi = "cxx11")` (`x86_64-w64-mingw32-cxx11`)

## Dependencies

The following JLL packages are required by `pocl_next_jll.jl`:
